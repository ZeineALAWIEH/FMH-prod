    ...
    <> 
     <h2 className='text-center font-bold text-5xl pt-12'>Les derniers héros ajoutés par les autres utilisateurs</h2>
      ...
      <div className="card lg:card-side bg-base-100 shadow-xl my-20 border-2 ">
        ...
        <figure>
          <img src={firstLastHero.photo_de_profil} alt="Album" className="md:h-96 lg:h-auto " />
        </figure>
        ...
        <div className="card-body">
          ...
          <div className="card-actions justify-center lg:justify-end">
            <Link to={`/heros/${firstLastHero.id}`} className="btn btn-primary">
      ...
      <div className="card lg:card-side bg-base-100 shadow-xl my-20 border-2 flex flex-col flex-row-reverse ">
        ...
        <div className="card-body">
          ...
          <div className="card-actions justify-center lg:justify-start">
            <Link to={`/heros/${secondLastHero.id}`} className="btn btn-primary" >
              Voir la fiche du héro
            </Link>
          </div>
        </div>
        ...
        <figure className="order-first lg:order-last">
          <img src={secondLastHero.photo_de_profil} alt="Album" className="md:h-96 lg:h-auto " />
        </figure>
