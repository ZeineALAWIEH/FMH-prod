...
export const fetchLogin = createAsyncThunk('user/fetchLogin', async (_, thunkAPI) => {
    ...
    const { data } = await axios.post("http://localhost/public_html/oclock-www/Apotheose/projet-15-find-my-hero-back/public/api/login_check", credentialsSubmit); 
...
export const fetchUserAuthorization = createAsyncThunk('user/fetchUserAuthorization', async () => {
    ...
    const { data } = await axios.get("http://localhost/public_html/oclock-www/Apotheose/projet-15-find-my-hero-back/public/api/user/", axiosConfig); 
...
export const fetchRegisterUser = createAsyncThunk('user/fetchRegisterUser', async (_, thunkAPI) => {
  ...
  const { data } = await axios.post("http://localhost/public_html/oclock-www/Apotheose/projet-15-find-my-hero-back/public/api/user/add", credentialsSubmit); 
...
export const fetchUserReview = createAsyncThunk('user/fetchUserReview', async (heroId:number|string|undefined, thunkAPI) => {
  ...
  const { data } = await axios.post(`http://localhost/public_html/oclock-www/Apotheose/projet-15-find-my-hero-back/public/api/reviews/personnage/${heroId}/add`, review ); 
...
export const fetchUserAddFavorites = createAsyncThunk('user/fetchUserAddFavorites', async (heroId:number|string|undefined) => {
  ...
  const { data } = await axios.post(`http://localhost/public_html/oclock-www/Apotheose/projet-15-find-my-hero-back/public/api/favorites/user/add/${heroId}`); 
...
export const fetchUserDelFavorites = createAsyncThunk('user/fetchUserDelFavorites', async (heroId:number|string|undefined) => {
  ...
  const { data } = await axios.delete(`http://localhost/public_html/oclock-www/Apotheose/projet-15-find-my-hero-back/public/api/favorites/user/delete/${heroId}`); 
...
export const fetchUserFavorites = createAsyncThunk('user/fetchUserFavorites', async () => {
  ...
  const { data } = await axios.get(`http://localhost/public_html/oclock-www/Apotheose/projet-15-find-my-hero-back/public/api/favorites/user/`); 
