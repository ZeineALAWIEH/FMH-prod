...
export const fetchHeros = createAsyncThunk('heros/fetchHeros', async () => {
    ...
    const { data } = await axios.get(`http://localhost/public_html/oclock-www/Apotheose/projet-15-find-my-hero-back/public/api/personnages`); 
...
export const fetchSingleHero = createAsyncThunk('heros/fetchSingleHero', async (heroId:number|string|undefined) => {
    ...
    const { data } = await axios.get(`http://localhost/public_html/oclock-www/Apotheose/projet-15-find-my-hero-back/public/api/personnages/${heroId}`);
...
export const fetchSingleHeroRandom = createAsyncThunk('heros/fetchSingleHeroRandom', async () => {
    ...
    const { data } = await axios.get(`http://localhost/public_html/oclock-www/Apotheose/projet-15-find-my-hero-back/public/api/personnages/random`);
...
export const fetchHeroVideos = createAsyncThunk('heros/fetchHeroVideos', async () => {
    ...
    const { data } = await axios.get(`http://localhost/public_html/oclock-www/Apotheose/projet-15-find-my-hero-back/public/api/videos`);
...
export const fetchAddHeros = createAsyncThunk('heros/fetchAddHeros', async (_, thunkAPI) => {
    ...
    const { data } = await axios.post(`http://localhost/public_html/oclock-www/Apotheose/projet-15-find-my-hero-back/public/api/personnages/add`, state.addHero.hero);
